...
<?php
	if (isset($_POST['simpan'])) {
		...
		$koneksi->query("INSERT INTO tb_jdwl_ujian (id_jdwl_ujian,id_calon_siswa,tanggal, jam,ruangan,) VALUES ('',,'',$_POST[tanggal]','$_POST[jam]','$_POST[ruangan]')");

		echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=jadwal_ujian'>";
		echo "<div class='alert alert-info'>Data Berhasil Di Tambahkan</div>";
	}
?>