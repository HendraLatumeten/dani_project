...
<!--    <a href="report.php"  class="btn btn-primary" align="center" >>Download Data</a>  -->
   <a href="report.php?&id=<?php echo $pecah['no_pendaftaran']; ?>" class="btn btn-primary" align="center">Download Data</a>
</div>
